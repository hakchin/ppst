...
/// Main rules section with all rules in card grid
#[component]
fn RulesSection() -> impl IntoView {
    view! {
        <section class="py-16">
            <div class="container-section">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white rounded-xl p-6 border border-gray-200">
                        ...
                        <p class="text-gray-700 text-sm">"학원 강의를 녹화하여 그 동영상을 보여주는 방식의 보강이 유행입니다. 그럴 것이면 차라리 해당 과정의 EBS 인강 추천드립니다. 필요시 교재까지 무료로 제공해 드립니다. 재원생 누구든 편하게 요청하세요."</p>
                    </div>
